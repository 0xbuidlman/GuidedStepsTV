 ...
 */
public class DetailsEnteryFormFragment extends GuidedStepFragment {

    private static final String TAG = "DetailsEnteryFormFragment";
    ...
    private static void addEditableAction(List<GuidedAction> actions,long id, String title, String desc,int inputType){
        actions.add(new GuidedAction.Builder()
                .id(id)
                .title(title)
    ...
    public void onCreateActions(@NonNull List<GuidedAction> actions, Bundle savedInstanceState) {
        addEditableAction(actions,ACTION_NAME,getString(R.string.two_opts_name),entry.getName(),InputType.TYPE_CLASS_TEXT);
